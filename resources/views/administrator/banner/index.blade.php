...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="btn-group"> 
        <a href="{{ asset('administrator/banner/tambah') }}" style="color: white;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                @if($banner->gambar)
                    <img src="{{ asset('admin/upload/banner/'.$banner->gambar) }}" class="img img-fluid img-thumbnail" alt="Gambar {{ $banner->judul }}" style="max-width: 100px;">
                @else
            ...
            <td>
                <div class="btn-group">
                <a href="{{ asset('administrator/banner/edit/'.$banner->id_banner) }}" 
