<p class="text-right">
	<a href="{{ asset('administrator/banner') }}" class="btn btn-outline-info btn-sm">
...
@endif
<form action="{{ asset('administrator/banner/proses-tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<input type="hidden" name="csrf_test_name" value="155e3af88478230f860a934020e9214a">

<div class="form-group row">
	<label class="col-md-3">Judul Banner</label>
	<div class="col-md-9">
...
<div class="form-group row">
	<label class="col-md-3">Upload Foto Banner</label>
	<div class="col-md-6">
